				...
				<div class="col-lg-6" style="width: 1025px;">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="ThemPB.htm" class="btn btn-primary">Thêm Phòng Ban</a>
						</div>
						<!-- /.panel-heading -->
									...
									<tbody>
										<c:forEach items="${dept}" var="d">
											<tr class="info">
												...
												<td><a href="SuaPB.htm?id=${d.ID}&name=${d.name}" class="btn btn-primary">Sửa</a></td>
												<td><a href="XoaPB.htm?id=${d.ID}" class="btn btn-primary" onclick="return confirm('Bạn Muốn Xóa?')">Xóa</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
