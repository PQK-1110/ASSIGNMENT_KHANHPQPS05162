					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="table-responsive">
								<form action="XLSua.htm" style="margin-left: 300px;">
									<label>ID</label> <input name="IDPB" readonly="readonly" value="${id}" type="text" style="width: 400px;" class="form-control" />
									<label>Phòng Ban</label> <input name="TPB" type="text" value="${name}" style="width: 400px;" class="form-control" /> <br><br>
