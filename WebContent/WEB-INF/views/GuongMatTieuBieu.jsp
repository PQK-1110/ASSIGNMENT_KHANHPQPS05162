			...
			<div class="row">
				...
				<div class="col-lg-6" style="width: 1005px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">Top 10 Nhân Viên Xuất Sắc</div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach items="${top10}" var="top">
											<tr class="info">
												<td><img alt="img" src="<%= request.getContextPath()%>/${top.photo}" style="width: 200px; height: 200px; margin-right: -105px;" /></td>
												<td>${top.username}</td>
												<td>${top.name}</td>
												<td>${top.dept.name}</td>
											</tr>
