	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.htm">Nintendo</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="login/index.htm"><i
								class="fa fa-dashboard fa-fw"></i> Trang Chủ</a></li>

						<li><a href="showDepart.htm"><i class="fa fa-table fa-fw"></i>
								Phòng Ban</a></li>
						<li><a href="showStaff.htm"><i class="fa fa-table fa-fw"></i>
								Nhân Viên</a></li>
						<li><a href="showRecord.htm"><i class="fa fa-edit fa-fw"></i>
								Thành Tích</a></li>
						<li><a href="showTop.htm"><i
								class="fa fa-bar-chart-o fa-fw"></i> Gương Mặt Tiêu Biểu</a></li>
					</ul>
				</div>
				<!-- /.sidebar-collapse -->
			</div>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<div class="col-lg-6" style="width: 1025px;">
						...
						<div class="panel-body">
							<div class="table-responsive">
								<form action="" style="margin-left: 300px;">
									<label>Họ Và Tên</label> <input type="text" style="width: 400px;" class="form-control" />
									...
									<label>Ngày Sinh</label> <input type="date" style="width: 400px;" class="form-control" />
									<label>Lương</label> <input type="number" style="width: 400px;" class="form-control" /> 
									<label>Điện Thoại</label> <input type="number" style="width: 400px;" class="form-control" />
									<label>Phòng Ban</label> <input type="text" style="width: 400px;" class="form-control" /> <br>
									<select style="width: 300px;">
    									<option value="KD">Phòng Kinh Doanh</option>
    									<option value="KT">Phòng Kế Toán</option>
    									<option value="NT">Phòng Nhân Sự</option>
    									<option value="PT">Phòng Phát Triển</option>
    									<option value="SX">Phòng Sản Xuất</option>
    									<option value="TN">Phòng Thu Ngân</option>
 									</select> <br> <br>
									<a href="showStaff.htm" type="submit" class="btn btn-primary" onclick="alert('Đã Sửa')">Sửa</a>
