					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="table-responsive">
								<form action="XLThem.htm" style="margin-left: 300px;">
									<label>ID</label> <input name = "IDPB" type="text" style="width: 400px;" class="form-control" />
									<label>Phòng Ban</label> <input name = "TPB" type="text" style="width: 400px;" class="form-control" /> <br><br>
